...
/**
 * A collection of classes which represent OverloadParameterConversion detectors,
 * each with its own type of context.
 */
public final class OverloadParameterConversion {
	private OverloadParameterConversion(){}
	
	/**
	 * Class representing a OverloadParameterConversion detector for a method.
	...
	public static class Method extends Detector<MethodSet> {
		...
		public MethodSet actualRisks() {
			return new ProgramComponentsGenerator()
					...
					.methods()
					.autoNarrowingOverloads(subject)
					.collect();
		}
